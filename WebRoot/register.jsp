...
<body style="background-image:url('https://www.afsa.gov.au/sites/g/files/net1601/f/images/slide/slide-building-min.jpg');">
<!-- banner -->
	<div class="center-container">
		<div class="main">
			<h1 class="w3layouts_head">Register Yourself...</h1>
			<!---728x90--->
...
user_tag_config['ebound_header_tag']['mobile']['adsCode'] = '';
				...
				<div class="w3layouts_main_grid">
					<form action="RegisterLogin?q=reg" method="post" class="w3_form_post">
					...
					<div class="w3_agileits_main_grid w3l_main_grid">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input type="text" name="ministry" placeholder="Your Name" required="">
							</span>
						</div>
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/29-06-2017/event_registration_form-demo_Free/744047052/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Aug 2018 12:20:56 GMT -->
</html>